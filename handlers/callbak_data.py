...
async def akkaunts(n,name,id):
    if int(cheak_black(id)) == 0:
        ...
        akks = [0,akk1,akk2,akk3,akk4,akk5,akk6,akk7,akk8,akk9,akk10,akk11,akk12,akk13,akk14,akk15,akk16,akk17] #Нулевой эллемент - Ноль
...
После этого повтори попытку""")
                    if i == 4444:
                        await message.answer(text="У тебя слишком много каналов. Выйди из каких-нибудь и повтори попытку")
                    if i == 8932:
                        await message.answer(text="""Не могу создать тебе прокладку и добавить тебя туда.
